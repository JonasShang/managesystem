<template>
  <div class="app-container">
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="商品编号" prop="spbh">
            <el-input v-model="queryParams.spbh" clearable/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="商品名称" prop="spmc">
            <el-input v-model="queryParams.spmc" clearable/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="商品属性" prop="spsx">
            <el-input v-model="queryParams.spsx" maxlength="30" clearable/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="商品货源" prop="sphyd">
            <el-input v-model="queryParams.sphyd" maxlength="100" clearable/>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <el-table v-loading="loading" :data="goodsInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品编号" prop="spbh" width="75" align="center"/>
      <el-table-column label="商品名称" prop="spmc" width="120" align="center"/>
        <el-table-column label="商品价格" prop="spjg" :show-overflow-tooltip="true" width="75" align="center"/>
        <el-table-column label="商品单位" prop="spdw" :show-overflow-tooltip="true" width="75" align="center"/>
        <el-table-column label="商品进价" prop="spjj" width="75" align="center"/>
        <el-table-column label="商品货源" prop="sphyd"  width="200"align="center"/>
        <el-table-column label="进货电话" prop="spjhdh" width="110"align="center"/>
        <el-table-column label="商品备注" prop="bz"  width="110"align="center"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          <el-row>
            <el-col :span="12">
              <el-form-item label="商品编号" prop="spbh1">
                <el-input v-model="form.spbh1" :readonly="readonly" placeholder="请输入商品编号" />
              </el-form-item>
              <el-form-item label="商品名称" prop="spmc">
                <el-input v-model="form.spmc" placeholder="请输入商品名称" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="商品属性" prop="spsx">
                <el-input v-model="form.spsx" placeholder="请输入商品属性" />
              </el-form-item>
              <el-form-item label="商品价格" prop="spjg">
                <el-input v-model="form.spjg" placeholder="请输入商品价格" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="商品单位" prop="spdw">
                <el-input v-model="form.spdw" placeholder="请输入商品单位" />
              </el-form-item>
              <el-form-item label="商品进价" prop="spjj">
                <el-input v-model="form.spjj" placeholder="请输入商品进价" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="商品货源" prop="sphyd">
                <el-input v-model="form.sphyd" placeholder="请输入商品货源" />
              </el-form-item>
              <el-form-item label="进货电话" prop="spjhdh">
                <el-input v-model="form.spjhdh" placeholder="请输入进货电话" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="商品备注" prop="bz">
                <el-input v-model="form.bz" placeholder="请输入商品备注" />
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
