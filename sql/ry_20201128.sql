...
insert into sys_menu values('4', '商品管理', '0', '4', 'goods',            null,   1, 0, 'M', '0', '0', '', 'tool',     'admin', sysdate(), '', null, '商品管理目录');
insert into sys_menu values('5', '若依官网', '0', '5', 'http://ruoyi.vip', null ,  0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
...
insert into sys_menu values('117',  '商品信息', '4',   '1', 'goodsInfo',  'goods/goodsInfo/index',    1, 0, 'C', '0', '0', 'goods:goodsInfo:list',    'goods',         'admin', sysdate(), '', null, '商品管理菜单');
-- 三级菜单
